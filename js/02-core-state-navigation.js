...
const modes = {
  ...
  imp:{
    ...
    settings:[
      ...
      {key:'time_turn', label:'Temps de parole par tour', type:'seg', options:['30 sec','45 sec','1 min','2 min'], val:1},
    ]
  }
};
...
function launchGame(){
  ...
  setTimeout(()=>document.getElementById(sid).classList.add('active'),80)
}
